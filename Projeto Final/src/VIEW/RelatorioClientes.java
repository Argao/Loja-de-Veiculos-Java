...
public class RelatorioClientes extends javax.swing.JFrame {
     ...
     */
    public RelatorioClientes(int id) {
        idLogado = id;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        filtroComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nome", "CPF", " " }));
        ...
        jLabel22.setText("RELATÓRIO DE CLIENTES");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(23, 23, 23)
                        .addComponent(filtroComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 89, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(arquivoTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(exportar, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void pesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pesquisarActionPerformed
        ...
        if(idLogado == 1){
            switch (filtro){
                case 0:
                    area.setText(ClienteController.relatorioPorNomeRoot(pesquisaTxt.getText()));
                    break;
                case 1:
                    area.setText(ClienteController.relatorioPorCpfRoot(pesquisaTxt.getText()));
                    break;
            }
        }else {
            switch (filtro){
                case 0:
                    area.setText(ClienteController.relatorioPorNome(pesquisaTxt.getText()));
                    break;
                case 1:
                    area.setText(ClienteController.relatorioPorCpf(pesquisaTxt.getText()));
                    break;
            }
        }
       //
    ...
    private void exportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exportarActionPerformed
        // TODO add your handling code here:
        ClienteController.exportaTxt(arquivoTextField.getText(),area.getText());
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        // TODO add your handling code here:
        if (idLogado == 1){
            area.setText(ClienteController.relatorioGeralRoot());
        }else {
            area.setText(ClienteController.relatorioGeral());
        }
